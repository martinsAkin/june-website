...
const ProductDropdownCard = () => {
  return (
    <div className="bg-[#20113c] font-inter font-normal text-white px-4 pt-5 rounded-lg shadow-xl w-max max-lg:shadow-[inset_0_0_0_2px_rgba(255,255,255,0.21)] max-md:mx-0 max-lg:w-full">
